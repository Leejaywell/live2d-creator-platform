...
POSTGRES_CONTAINER="live2d-browser-qa-postgres"
PIDS=""
...
QA_BASE_URL="http://localhost:3300" QA_EXPECT_LIVE2D="false" tsx scripts/provision-qa.ts --app-env-file .env.integration.host --write-env .env.qa.host
QA_HEADLESS="${QA_HEADLESS:-true}" tsx scripts/browser-qa.ts --app-env-file .env.qa.host
